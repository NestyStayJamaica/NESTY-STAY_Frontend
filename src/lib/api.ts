...
export type PmMaintenanceCase = { id: string; ownerUserId: string; propertyId: string; vendorId?: string | null; number: string; title: string; description: string; status: string; priority: string; selectedQuoteAmount?: number | null; expenseAmount: number; ownerCharge: number; managerFee: number; scheduledAt?: string | null; currency: string; rowVersion: number };
...
export type PmCleaning = { id: string; propertyId: string; bookingId?: string | null; assignedUserId?: string | null; vendorId?: string | null; dueAt: string; status: string; checklistJson: string; photosJson: string; issues: string; completedAt?: string | null; rowVersion: number };
